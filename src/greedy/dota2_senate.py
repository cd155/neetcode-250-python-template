...
'D' represent the Radiant party and the Dire party. Then if there are n senators, the
...
Predict which party will finally announce the victory and change the Dota2 game. The
...
And the second senator can't exercise any rights anymore since his right has been
banned.
And the third senator comes from Dire and he can ban the first senator's right in round
1.
...
class Solution:
    def predictPartyVictory(self, senate):
        """
        Predict which party announces victory in the Dota2 senate.

        Args:
            senate: str - senate[i] is 'R' (Radiant) or 'D' (Dire)
