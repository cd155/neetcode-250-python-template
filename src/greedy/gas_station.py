...
class Solution:
    def canCompleteCircuit(self, gas, cost):
        """
        Find the starting gas station for a full circuit.

        Args:
            gas: List[int] - gas[i] is the amount of gas at station i
            cost: List[int] - cost[i] is the gas needed to travel from station i to i + 1

        Returns:
            int - starting station index, or -1
...
if __name__ == "__main__":
    ...
    # Test case 1
    result = solution.canCompleteCircuit([1, 2, 3, 4, 5], [3, 4, 5, 1, 2])
