...
correct change to each customer so that the net transaction is that the customer pays
$5.
...
class Solution:
    def lemonadeChange(self, bills):
        """
        Check whether you can give every customer correct change.

        Args:
            bills: List[int] - bills[i] is the bill paid by the i-th customer

        Returns:
            bool - True if every customer gets correct change
