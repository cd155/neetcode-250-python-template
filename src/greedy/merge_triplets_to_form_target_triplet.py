...
Output: false
Explanation:
It is impossible to have [3,2,5] as an element because there is no 2 in any of the
triplets.
...
fourth triplet to be [max(2,5), max(5,2), max(5,3)] = [5,5,5]. triplets =
...
class Solution:
    def mergeTriplets(self, triplets, target):
        """
        Check whether target can be obtained by merging triplets.
        ...
        Returns:
            bool - True if target can be obtained
...
if __name__ == "__main__":
    ...
    # Test case 2
    result = solution.mergeTriplets([[3, 4, 5], [4, 5, 6]], [3, 2, 5])
