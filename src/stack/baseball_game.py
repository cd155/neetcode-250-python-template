...
- operations[i] is "C", "D", "+", or a string representing an integer in the range [-3 *
  10^4, 3 * 10^4].
...
class Solution:
    def calPoints(self, operations):
        """
        Compute the total score after applying all operations.

        Args:
            operations: List[str] - list of score operations

        Returns:
            int - sum of the scores on the record
