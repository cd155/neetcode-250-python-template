...
class WordDictionary:
    ...
    def addWord(self, word):
        ...
        Args:
            word: str - word (may contain '.' in search)
    ...
    def search(self, word):
        """
        Check whether any stored word matches word ('.' matches any letter).
...
if __name__ == "__main__":
    ...
    wordDictionary.addWord("dad")
    wordDictionary.addWord("mad")
    print("search('pad'):", wordDictionary.search("pad"))  # False
    print("search('bad'):", wordDictionary.search("bad"))  # True
    print("search('.ad'):", wordDictionary.search(".ad"))  # True
    print("search('b..'):", wordDictionary.search("b.."))  # True
