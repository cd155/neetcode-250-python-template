...
Output: [1]
Explanation:
As shown, the height of the tree is 1 when the root is the node with label 1 which is
the only MHT.
...
class Solution:
    def findMinHeightTrees(self, n, edges):
        """
        Find the roots that give minimum height trees.
        ...
        Returns:
            List[int] - root labels in any order
