...
class Solution:
    def pacificAtlantic(self, heights):
        """
        Find cells from which rain water can flow to both oceans.

        Args:
            heights: List[List[int]] - heights[r][c] is the height of cell (r, c)

        Returns:
            List[List[int]] - coordinates [r, c] in any order
