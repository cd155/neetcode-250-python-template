...
class Solution:
    def findRedundantConnection(self, edges):
        """
        Find an edge whose removal turns the graph back into a tree.

        Args:
            edges: List[List[int]] - edges[i] = [a, b] (1-indexed nodes)

        Returns:
            List[int] - the redundant edge (the last one in the input)
...
if __name__ == "__main__":
    ...
    # Test case 2
    result = solution.findRedundantConnection([[1, 2], [2, 3], [3, 4], [1, 4], [1, 5]])
