...
labeled ai trusts the person labeled bi. If a trust relationship does not exist in trust
...
class Solution:
    def findJudge(self, n, trust):
        """
        Find the town judge, who trusts nobody and is trusted by everybody else.

        Args:
            n: int - number of people, labeled 1 to n
            trust: List[List[int]] - trust[i] = [a, b] means person a trusts person b

        Returns:
            int - label of the town judge, or -1
