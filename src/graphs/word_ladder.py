...
Output: 5
Explanation:
One shortest transformation sequence is "hit" -> "hot" -> "dot" -> "dog" -> cog", which
is 5 words long.
...
Output: 0
Explanation:
The endWord "cog" is not in wordList, therefore there is no valid transformation
sequence.
...
class Solution:
    def ladderLength(self, beginWord, endWord, wordList):
        ...
        Args:
            ...
            wordList: List[str] - list of allowed words

        Returns:
            int - number of words in the shortest sequence, or 0
...
if __name__ == "__main__":
    ...
    # Test case 2
    result = solution.ladderLength("hit", "cog", ["hot", "dot", "dog", "lot", "log"])
