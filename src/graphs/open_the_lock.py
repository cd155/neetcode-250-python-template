...
class Solution:
    def openLock(self, deadends, target):
        """
        Minimum turns to open the lock without hitting a dead end.

        Args:
            deadends: List[str] - list of dead-end combinations
            target: str - combination that opens the lock

        Returns:
            int - minimum number of turns, or -1
...
if __name__ == "__main__":
    ...
    # Test case 1
    result = solution.openLock(["0201", "0101", "0102", "1212", "2002"], "0202")
    print(f"Test 1: {result}")

    # Test case 2
    result = solution.openLock(["8888"], "0009")
