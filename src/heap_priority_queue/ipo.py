...
Venture Capital, LeetCode would like to work on some projects to increase its capital
...
class Solution:
    def findMaximizedCapital(self, k, w, profits, capital):
        ...
        Args:
            k: int - maximum number of projects
            w: int - initial capital
            profits: List[int] - profits[i] is the profit of the i-th project
            capital: List[int] - capital[i] is the minimum capital needed to start the i-th project

        Returns:
            int - maximized final capital
...
if __name__ == "__main__":
    ...
    # Test case 2
    result = solution.findMaximizedCapital(3, 0, [1, 2, 3], [0, 1, 2])
