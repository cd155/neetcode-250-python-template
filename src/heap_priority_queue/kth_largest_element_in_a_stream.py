...
class KthLargest:
    def __init__(self, k, nums):
        """
        Initialize the object with k and the initial stream of scores.

        Args:
            k: int - rank to track
            nums: List[int] - initial stream of scores
    ...
    def add(self, val):
        ...
        Returns:
            int - k-th largest element after adding val
...
if __name__ == "__main__":
    ...
    print("add(3):", kthLargest.add(3))  # 4
    print("add(5):", kthLargest.add(5))  # 5
    print("add(10):", kthLargest.add(10))  # 5
    print("add(9):", kthLargest.add(9))  # 8
    print("add(4):", kthLargest.add(4))  # 8
