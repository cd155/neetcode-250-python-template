...
Follow up: Could you write a generalized algorithm to work on any possible set of
characters?
"""
...
if __name__ == "__main__":
    ...
    print(f"Test 1: {codec.decode(encoded)}")

    # Test case 2
    encoded = codec.encode([""])
    print(f"Test 2: {codec.decode(encoded)}")
