...
share of the stock at any time. However, you can sell and buy the stock multiple times
...
Output: 0
Explanation:
There is no way to make a positive profit, so we never buy the stock to achieve the
maximum profit of 0.
...
class Solution:
    def maxProfit(self, prices):
        """
        Maximum profit when you may buy and sell the stock many times.
