...
Output: [0,0,1,1,2,2]
Explanation:
The array has two 0s, two 1s, and two 2s. Sorting them in-place places all 0s first,
...
class Solution:
    def sortColors(self, nums):
        """
        Sort the 0s, 1s and 2s in-place (Dutch national flag).

        Args:
            nums: List[int] - colors 0 (red), 1 (white) and 2 (blue)
