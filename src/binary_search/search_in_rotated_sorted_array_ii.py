...
nums[0], nums[1], ..., nums[k-1]] (0-indexed). For example, [0,1,2,4,4,4,5,6,6,7] might
be rotated at pivot index 5 and become [4,5,6,6,7,0,1,2,4,4].
...
class Solution:
    def search(self, nums, target):
        ...
        Returns:
            bool - True if target is in nums
