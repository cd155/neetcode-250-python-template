...
timeMap.get("foo", 3);         // return "bar", since there is no value corresponding to
...
class TimeMap:
    ...
    def set(self, key, value, timestamp):
        """
        Store key with value at the given timestamp.
    ...
    def get(self, key, timestamp):
        """
        Get the value set for key at the latest timestamp <= timestamp.
...
if __name__ == "__main__":
    ...
    print("get('foo', 1):", timeMap.get("foo", 1))  # "bar"
    print("get('foo', 3):", timeMap.get("foo", 3))  # "bar"
    timeMap.set("foo", "bar2", 4)
    print("get('foo', 4):", timeMap.get("foo", 4))  # "bar2"
    print("get('foo', 5):", timeMap.get("foo", 5))  # "bar2"
