...
Explanation:
Your function should return k = 5, with the first five elements of nums being 0, 1, 2,
...
class Solution:
    def removeDuplicates(self, nums):
        ...
        Args:
            nums: List[int] - array sorted in non-decreasing order
...
if __name__ == "__main__":
    ...
    print(f"Test 1: k = {k}, nums = {nums}")

    # Test case 2
    nums = [0, 0, 1, 1, 1, 2, 2, 3, 3, 4]
    k = solution.removeDuplicates(nums)
    print(f"Test 2: k = {k}, nums = {nums}")
