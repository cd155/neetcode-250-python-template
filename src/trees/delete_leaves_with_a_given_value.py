...
class Solution:
    def removeLeafNodes(self, root, target):
        """
        Repeatedly delete leaf nodes whose value is target.

        Args:
            root: Optional[TreeNode] - root of the binary tree
            target: int - value of the leaves to delete

        Returns:
            Optional[TreeNode] - root of the updated tree
