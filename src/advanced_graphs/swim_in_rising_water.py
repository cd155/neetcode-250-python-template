...
class Solution:
    def swimInWater(self, grid):
        """
        Least time to swim from the top-left to the bottom-right cell.

        Args:
            grid: List[List[int]] - grid[i][j] is the elevation of cell (i, j)
...
if __name__ == "__main__":
    ...
    # Test case 1
    result = solution.swimInWater([[0, 2], [1, 3]])
